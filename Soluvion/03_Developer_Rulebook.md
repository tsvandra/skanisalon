...
### 4.1. AI Integráció
* [cite_start]**API Kulcs Biztonság:** > Szigorúan TILOS API kulcsot (`sk-...`) a forráskódban vagy config fájlban commitolni[cite: 204]. [cite_start]Ha véletlenül megtörténik, azonnal vissza kell vonni[cite: 205].
